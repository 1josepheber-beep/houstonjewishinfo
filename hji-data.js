...
(function () {
  ...
  "KosherRestaurants": { t: "kosherrestaurants", c: [["Name","name","text"], ["Description","description","text"], ["Address","address","text"], ["Phone","phone","text"], ["Email","email","text"], ["Website","website","text"], ["Hours","hours","text"], ["Badge","badge","text"], ["Category","category","text"], ["Kashrut","kashrut","text"], ["Hechsher","hechsher","text"], ["CardImage","cardimage","text"], ["hide_reviews","hide_reviews","text"], ["place_id","place_id","text"], ["google_rating","google_rating","numeric"], ["google_reviews_count","google_reviews_count","integer"], ["google_reviews_updated","google_reviews_updated","timestamptz"], ["Status","status","text"]] },
  ...
  "Activities": { t: "activities", c: [["Name","name","text"], ["Category","category","text"], ["IndoorOutdoor","indooroutdoor","text"], ["URL","url","text"], ["Address","address","text"], ["Free","is_free","text"], ["Hechsher","hechsher","text"], ["Status","status","text"]] },
